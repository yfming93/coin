...
- (UIActivityIndicatorView *)indecator {
    if (_indecator == nil) {
        ...
        _indecator.frame = CGRectMake((self.width - _indecator.width)/2, (self.height - _indecator.height)/2, _indecator.width, _indecator.height);
