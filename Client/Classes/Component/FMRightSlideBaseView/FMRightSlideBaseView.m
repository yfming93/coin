...
- (instancetype)initWithTargetVc:(UIViewController *)targetVc widthScale:(CGFloat)widthScale menuBgColor:(UIColor *)menuBgColor {
    ...
    if (self) {
        ...
        self.back = [[UIView alloc] initWithFrame:CGRectMake( kScreenW * (1.0 - (widthScale ? widthScale:0.6)), 0, kScreenW * (widthScale ? widthScale:0.6), kScreenH)];
        ...
        self.backOver = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenW - self.back.width, self.back.height)];
