...
typedef NS_ENUM(NSInteger, JinnLockVerifyResultType)
{
    JinnLockVerifyResultTypeGestureUnlockSuccess,
    JinnLockVerifyResultTypeGestureUnlockFailure,
    JinnLockVerifyResultTypeGestureUnlockFCancel,
    JinnLockVerifyResultTypeTouchIdSuccess,
    JinnLockVerifyResultTypeTouchIdFailure,
    JinnLockVerifyResultTypeTouchIdCancel,
};
...
typedef void (^LockVerifyResultBlock)(id objc, JinnLockVerifyResultType type);
