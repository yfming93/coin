...
/** 选中item 视图的背景颜色 */
@property (nonatomic, strong) UIColor *itemSelectedBackColor;
/** 非选中item 视图的背景颜色 */
...
/** 距离导航的高度 */
@property (nonatomic, assign) CGFloat topToNav;
/** 选中标签下划线高度 */
@property (nonatomic, assign) CGFloat bottomLineHeight;
/** 选中标签下划线宽度 */
@property (nonatomic, assign) CGFloat bottomLineWidth;
/** 下划线底色的屏幕分割线颜色 */
@property (nonatomic, strong) UIColor *bottomScreenLineColor;
/** 选中标签底部划线颜色 */
