...
-(void)createPageControl{
    ...
    _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake((self.frame.size.width - 50)/2, ZXMainScrollViewHeight - 30, 50, 30)];
...
//    _pageControl.currentPageIndicatorTintColor = self.curPageControlColor;
    if (_curPageControlIma) {
        [_pageControl setValue:_curPageControlIma forKeyPath:@"_currentPageImage"];
    }
    if (_otherPageControlIma) {
        [_pageControl setValue:_otherPageControlIma forKeyPath:@"_pageImage"];
    }
