...
#import "NSDate+FMAdd.h"
#import "FMCategoryKitMacro.h"
#import <time.h>

YYSYNTH_DUMMY_CLASS(NSDate_FMAdd)


@implementation NSDate (FMAdd)
...
- (NSString*)lunar{
    ...
    NSString *y_str = localeComp.year >= 1? [chineseYears objectAtIndex:localeComp.year-1] : nil;
    NSString *m_str = localeComp.month >= 1? [chineseMonths objectAtIndex:localeComp.month-1]: nil;
    NSString *d_str = localeComp.day >= 1? [chineseDays objectAtIndex:localeComp.day-1]: nil;
